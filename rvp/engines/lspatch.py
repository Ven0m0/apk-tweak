...
def run(ctx: Context) -> None:
    ...
    # -l <level>  : 2 = embed
    cmd = [
        "java", "-jar", str(lspatch_jar),
        "-l", "2",
        "-o", str(ctx.output_dir), # LSPatch takes a dir and auto-names, or we can rename later
        str(input_apk)
    ]
    ...
    # For robust handling, we find the newest file in output dir or strict naming if supported
