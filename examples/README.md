...
This directory contains example configurations and plugins to help you get started with the ReVanced Pipeline.
...
- **Paths**: Use `ctx.work_dir` for temporary files, `ctx.output_dir` for final output
