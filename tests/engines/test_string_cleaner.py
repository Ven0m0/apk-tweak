...
from rvp.engines.string_cleaner import _analyze_apk_strings, _remove_unused_strings, StringUsage
...
<resources>
    ...
    usage_map = {
        "used": StringUsage(name="used", is_used=True, locations=["res/values/strings.xml"]),
        "unused": StringUsage(name="unused", is_used=False, locations=["res/values/strings.xml"])
    }
