...
class TestContext:
  ...
  def test_set_current_apk_valid(self, tmp_path: Path) -> None:
  ...
  def test_set_current_apk_missing(self, tmp_path: Path) -> None:
  ...
  def test_log_method(self, tmp_path: Path, caplog: pytest.LogCaptureFixture) -> None:
